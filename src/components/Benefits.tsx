...
const benefits = [
  ...
  },
  {
    ...
    description: "Encuentra opciones en Bogotá, Medellín, Cali, Barranquilla y más ciudades.",
  },
  {
    icon: Wallet,
      ...
      <div className="container relative mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="group bg-card rounded-2xl p-6 border border-border/50 hover:border-primary/30 hover:shadow-card transition-all duration-300 hover:-translate-y-1"
            >
